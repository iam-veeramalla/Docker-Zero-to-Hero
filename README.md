...
Docker is a containerization platform that provides easy way to containerize your applications, which means, using Docker you can build container images, run the images to create containers. The docker images can be stored in regestries such as DockerHub, Quay.io and so on.
